...
export default function SavePasswordModal(props) {
    const SavePasswords = () => props.onSelection(true, document.getElementById("remember-save").checked);
    const DontSavePasswords = () => props.onSelection(false, document.getElementById("remember-save").checked);
        ...
        <div id="modal-background">
            <div id="modal-confirmation">
                ...
                <p>
                    ...
                    <br />
                    <b>Note: </b> Login information is encrypted and stored in the app's installed directory. <b>However</b>, anyone with access to your app's
                    directory can decrypt the passwords.
                    <br />
                ...
                <div id="modal-checkbox">
                    <input id="remember-save" name="remember-save" type="checkbox" />
